export default {
    jcyj: [{
        ...
        },
        {
            ...
            "route": "/roadnetworkrunmonitor/airTransportOperationIndex"
        },
        {
            "id": "12",
            "title": "铁路运输运行监测",
        ...
        },
        {
            ...
            "route": "/roadnetworkrunmonitor/industryStaticInforQueryIndex"
        },
        {
            "id": "18",
            "title": "驾培维修运行监测",
    ...
    yjxt: [{
        ...
        //     "title": "地面公交运行专题分析",
        //     "icon": require("../assets/index/menu/jpwx.png"),
        //     "route": "/emergencyCoordination/groundBusOperationIndex"
        // },
        // {
        //     "id": "24",
        //     "title": "重大活动专题监测",
        //     "icon": require("../assets/index/menu/fszlcl.png"),
        //     "route": "/emergencyCoordination/majorActivitiesIndex"
        // }
    ]
}